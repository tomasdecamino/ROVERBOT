...
ST_LINK = /usr/local/bin/
GCC_BIN = /home/alex/ARMToolChains/gcc-arm-none-eabi-4_9-2015q3/bin/
PROJECT = Carro
OBJECTS = ./main.o ./Traccion.o ./PID.o ./Carro.o ./QEI.o ./MMA7660.o
...
INCLUDE_PATHS = -I. -I$(INCLUDE_FILES) -I./mbed -I./mbed/TARGET_NUCLEO_F411RE -I./mbed/TARGET_NUCLEO_F411RE/TARGET_STM -I./mbed/TARGET_NUCLEO_F411RE/TARGET_STM/TARGET_STM32F4 -I./mbed/TARGET_NUCLEO_F411RE/TARGET_STM/TARGET_STM32F4/TARGET_NUCLEO_F411RE -I./mbed/TARGET_NUCLEO_F411RE/TOOLCHAIN_GCC_ARM 
...
CC_SYMBOLS = -DTARGET_FF_ARDUINO -DTOOLCHAIN_GCC_ARM -DTARGET_NUCLEO_F411RE -D__CORTEX_M4 -DTARGET_CORTEX_M -D__FPU_PRESENT=1 -D__MBED__=1 -DTARGET_M4 -DMBED_BUILD_TIMESTAMP=1447500460.8 -DTARGET_STM -DTARGET_STM32F4 -DTARGET_FF_MORPHO -DTOOLCHAIN_GCC -DTARGET_STM32F411RE -DARM_MATH_CM4 
...
.PHONY: all clean upload lst size
